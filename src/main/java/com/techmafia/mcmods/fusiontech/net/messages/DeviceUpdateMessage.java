package com.techmafia.mcmods.fusiontech.net.messages;

import com.techmafia.mcmods.fusiontech.net.messages.base.WorldMessageClient;
import com.techmafia.mcmods.fusiontech.tileentity.base.TileEntityFusiontechBase;
...
public class DeviceUpdateMessage extends WorldMessageClient {
    ...
    public static class Handler extends WorldMessageClient.Handler<DeviceUpdateMessage> {
        ...
        public IMessage handleMessage(DeviceUpdateMessage message, MessageContext ctx, TileEntity te) {
            ...
            if (te instanceof TileEntityFusiontechBase) {
                ((TileEntityFusiontechBase)te).onReceiveUpdate(message.compound);
            }
